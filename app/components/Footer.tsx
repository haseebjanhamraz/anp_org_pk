...
export default function Footer() {
    return (
        <>
            <div className="flex dark:bg-slate-900 gap-4 flex-col lg:flex-row shadow-inner drop-shadow-2xl pb-10 ">
                <div className="w-auto p-4 pt-6 dark:bg-slate-800 flex flex-col items-center justify-start">
                    <Image src="/anp-logo.png" className="mb-4" alt="ANP Logo" width={100} height={100} />
                    <Image src="/anp-calligraphy.png" className="mb-4" alt="عوامي نېشنل پارټي" width={200} height={200} />
                    <p className="dark:text-white font-[Montserrat-Light] text-sm text-justify">
                        ...
                        <Link href="/about" className="font-[Montserrat] font-bold text-red-500 hover:underline dark:hover:text-white">Read More</Link>
                    </p>
                </div>
                <div className="w-full">
                    <h1 className="text-center text-2xl font-[Montserrat] font-bold py-4 dark:text-white">Subscribe to our Newsletter</h1>
                    <NewsletterForm />
                </div>
                <div className="w-full">
                    <ImportantLinks />
