        ...
        <div className='flex flex-col gap-8'>
            ...
            <div className="flex gap-3">
                ...
                <div className="space-y-8">
                    ...
                    <p className="text-gray-700 dark:text-white font-bold text-lg text-justify">
