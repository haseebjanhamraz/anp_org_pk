...
export default function OverviewPashtunNationalism() {
    ...
    return (
        <div className='flex flex-col gap-8' id="overview">
            ...
            <div className="flex gap-3">
                <div className="bg-red-600 h-auto w-6"></div>
                <div className="space-y-8">
                    <p className="text-gray-700 dark:text-white text-md text-justify">
            ...
            <div className="flex gap-3">
                ...
                <div className="space-y-8">
                    <h4 className="border-r-8 w-fit px-10 py-2 text-2xl font-bold bg-red-600 dark:bg-red-800 text-white dark:text-gray-300">
                        Connection with the Indian National Congress and Opposition to British Colonial Rule                   </h4>
                    <p className="text-gray-700 dark:text-white text-md text-justify">
            ...
            <div className="flex gap-3">
                ...
                <div className="space-y-8">
                    <h4 className="border-r-8 w-fit px-10 py-2 text-2xl font-bold bg-red-600 dark:bg-red-800 text-white dark:text-gray-300">
                        Ideology, Methods, and Significance of the Khudai Khidmatgar Movement in British India</h4>
                    <p className="text-gray-700 dark:text-white text-md text-justify">
                        The Khudai Khidmatgar movement, founded by Khan Abdul Ghaffar Khan in 1929, was a revolutionary nonviolent resistance movement that aimed to empower the Pashtun people through self-reliance, community service, and a commitment to peaceful protest. Rooted in Bacha Khan’s vision of social reform, the Khudai Khidmatgar (translated as “Servants of God”) was structured to resist British colonial oppression and promote Pashtun unity and autonomy. Known for their iconic red shirts, which symbolized their devotion and unity, Khudai Khidmatgar members became famously known as the "Red Shirts" and stood out as a disciplined, highly organized force for change in British India.
                        Ideology of the Khudai Khidmatgar Movement
                        The ideology of the Khudai Khidmatgar movement centered on nonviolence, unity, social reform, and self-sufficiency. Inspired by Bacha Khan’s belief in Islamic principles of peace and justice, the movement espoused a philosophy that opposed the violent retaliation traditionally associated with Pashtun tribal conflicts. Bacha Khan argued that true bravery was found in self-control and discipline rather than aggression, and he taught that only through unity and peaceful resistance could the Pashtuns achieve freedom from colonial rule.
                        For Bacha Khan, nonviolence was both a spiritual and political commitment. He saw it as a powerful means of self-liberation and moral fortitude. The movement emphasized core values such as honesty, humility, discipline, and social service, encouraging Pashtuns to break free from societal ills like illiteracy, poverty, and internal division. Additionally, the Khudai Khidmatgar’s ideology was explicitly anti-colonial and nationalist, focusing on Pashtun self-empowerment and independence from British exploitation.
                        Methods and Activities of the Khudai Khidmatgar Movement
                        The Khudai Khidmatgar movement combined grassroots social reform with organized nonviolent resistance. Its members engaged in a wide range of activities, all aimed at uplifting the Pashtun community and undermining British control.
                    </p>
                    <ul className="text-lg font-bold dark:text-red-400 bg-slate-50 dark:bg-slate-800 p-2 rounded-md w-fit">
            ...
            <div className="flex gap-3">
                ...
                <div className="space-y-8">
                    <h4 className="border-r-8 w-fit px-10 py-2 text-2xl font-bold bg-red-600 dark:bg-red-800 text-white dark:text-gray-300">
                        Bacha Khan’s Role, Philosophies, and Alliances, Especially with Gandhi                   </h4>
                    <p className="text-gray-700 dark:text-white text-md text-justify">
            ...
            <div className="flex gap-3">
                ...
                <div className="space-y-8">
                    ...
                    <ul className="text-lg font-bold dark:text-red-400 bg-slate-50 dark:bg-slate-800 p-2 rounded-md w-fit">
                        ...
                        <ul className="text-lg font-bold dark:text-red-400 bg-slate-50 dark:bg-slate-800 p-2 rounded-md w-fit">
                            1.	Emphasis on Nonviolence and Service                            <li className="dark:text-white font-normal dark:bg-slate-900 bg-slate-100 p-3 rounded-md m-3">
                        ...
                        <ul className="text-lg font-bold dark:text-red-400 bg-slate-50 dark:bg-slate-800 p-2 rounded-md w-fit">
                            ...
                            <li className="dark:text-white font-normal dark:bg-slate-900 bg-slate-100 p-3 rounded-md m-3">
                                The Khudai Khidmatgar’s resistance to the partition of India was rooted in a vision of a united, secular South Asia, where all communities—regardless of religious or ethnic differences—could coexist peacefully. Bacha Khan and his followers strongly believed that dividing the country along religious lines would lead to long-lasting social and political turmoil, as well as jeopardize the unity of the Pashtun community.
                            </li>
                            1.	Ideological Alignment with a United India
                            <li className="dark:text-white font-normal dark:bg-slate-900 bg-slate-100 p-3 rounded-md m-3">
