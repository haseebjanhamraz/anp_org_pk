...
const Downloads = () => {
    ...
    return (
        <div className='mt-20 dark:border-2 dark:border-solid dark:border-gray-600 rounded-md shadow-lg p-10'>
            <h1 className='text-4xl dark:text-white font-semibold mb-4 text-center'>Downloads & Documents </h1>
