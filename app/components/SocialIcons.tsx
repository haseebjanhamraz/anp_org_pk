...
export default function SocialIcons() {
    return (
        <div className="flex flex-col items-center justify-center p-4 rounded-lg dark:bg-slate-800 m-3 shadow-md hover:shadow-lg transition-ease-in-out duration-300">
