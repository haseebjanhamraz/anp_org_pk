    ...
    <section className="bg-gray-100 dark:bg-gray-900">
      <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
        <div className="mr-auto place-self-center lg:col-span-7 animate-in zoom-in-50 duration-500">
          <h1 className="max-w-2xl mb-4 font-[opensans] text-4xl text-center font-bold uppercase tracking-tight leading-none text-red-500 md:text-5xl xl:text-6xl dark:text-white font-[Bebas Neue]">
