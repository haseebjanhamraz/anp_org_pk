...
const About = () => {
    return (
        <div className=" dark:bg-slate-900 p-6 sm:p-12 md:p-16 lg:p-12 ">
            <h1 className="text-3xl font-bold mb-4 dark:text-white">About</h1>

            <p className="text-md font-normal text-gray-700 text-justify dark:text-white">
            ...
            <ul className="list-disc ml-4">
                <li className="text-lg font-bold dark:text-red-600 text-red-600">
                    Federalism and Provincial Autonomy: {" "}
                    <span className="font-normal text-md text-black dark:text-white">
                ...
                <li className="text-lg font-bold dark:text-red-600 text-red-600">
                    ...
                    <span className="font-normal text-md text-black dark:text-white">
                        Drawing from the ideals of Bacha Khan and the Khudai Khidmatgar movement, ANP promotes secular policies, advocating for the separation of religion from state affairs to ensure a just and inclusive society for all citizens, irrespective of faith or ethnicity.
                    </span>
                </li>
                <li className="text-lg font-bold dark:text-red-600 text-red-600">
                    Education and Healthcare Reform:{" "}
                    <span className="font-normal text-md text-black dark:text-white">
                        ANP has consistently pushed for improved educational infrastructure and healthcare access in Pakistan, especially in KP and Balochistan. The party believes that quality education and healthcare are essential to lifting communities out of poverty and providing future opportunities for all citizens.
                    </span>
                </li>
                <li className="text-lg font-bold dark:text-red-600 text-red-600">
                    Anti-Extremism and Pro-Democracy:{" "}
                    <span className="font-normal text-md text-black dark:text-white">
                        During Pakistan’s involvement in the War on Terror, ANP firmly opposed the spread of extremist ideologies and the rise of Talibanization, particularly in Pashtun regions. The party has made considerable sacrifices in combating terrorism and promoting peace, often putting its leaders and members at great personal risk.
                    </span>
                </li>
            </ul>
            <h4 className="p-2 text-xl font-bold text-red-600 mt-4 mb-4 bg-gray-50 dark:bg-gray-800 w-fit shadow-md">
